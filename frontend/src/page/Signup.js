...
function Signup() {
  ...
  const handlePasswordChange = (e) => {
    ...
    if (!passwordRegex.test(newPassword)) {
      ...
      newPassword.includes("1234") ||
      newPassword.toLowerCase() === "password"
    ) {
      setPasswordError("Please choose a more secure password.");
    } else if (newPassword.toLowerCase().includes(username.toLowerCase())) {
      setPasswordError("Avoid using your username in the password.");
    } else if (
      newPassword.toLowerCase().includes(fname.toLowerCase()) ||
      newPassword.toLowerCase().includes(lname.toLowerCase())
    ) {
      setPasswordError(
        "Avoid using your first name or last name in the password."
      );
    } else {
      setPasswordError("");
    }
